    ...
    return (
        ...
        <div className="relative py-12">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute w-64 h-64 -left-32 top-0 bg-purple-500/20 rounded-full mix-blend-multipy fliter blur-3xl animate-blob">
                </div>
                                        ...
                                        <div>
                                            <div>
                                                ...
                                                <span className="text-sm font-medium text-purple-200">
                                                    {typeof image === "object" && "style" in image ? image.style : ""}
                                                </span>    
                                            </div>
                                            ...
                                            <p className="text-sm text-neutral-200">
                                                {typeof image === "object" && "description" in image ? image.description: ""}
                                            </p>
                                        </div>
                                    </motion.div>
                                </motion.div>
                            ...
                            {scrollSnaps.map((_, i) => (
                                ...
                                onClick={() => scrollTo(i)}>
                                    <div className="w-12 h-1.5 rounded-full bg-neutral-200 overflow-hidden">
                                        {i === selectedIndex && (
                                        <motion.div
                                            className=" rounded-xl absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600"
