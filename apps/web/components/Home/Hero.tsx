...
export function Hero(){
    return(
        ...
        <div className="dark:bg-black">
            <div className="relative min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-900 to-black text-white overflow-hidden">
                <BackgroundEffects/>
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 mt-10">
                    ...
                    className="mt-16 space-y-32">
                        {/* <TrustedBy /> */}
                        <section className="relative" id="ic">
