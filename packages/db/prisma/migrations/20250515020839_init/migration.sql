...
-- CreateEnum
CREATE TYPE "EthninictyEnum" AS ENUM ('White', 'Black', 'Asian American', 'East Asian', 'South East Asian', 'South Asian', 'Middle Eastern', 'Pacific', 'Hispanic');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Black', 'Brown', 'Blue', 'Hazel', 'Gray', 'Green');
...
CREATE TABLE "Model" (
    ...
    "ethinictiy" "EthninictyEnum" NOT NULL,
